...
import {
  ContextCompletionModal,
  type ContextCompletionSelections,
} from './ContextCompletionModal'
...
interface BugReportFormProps {
  ...
  onContextCompletionContinue?: (selections: ContextCompletionSelections) => void
  onContextCompletionSkip?: () => void
}
...
export function BugReportForm({
  ...
  onContextCompletionContinue,
  onContextCompletionSkip,
}: BugReportFormProps) {
...
Example: On Production, checkout button stays disabled after entering a valid address on iPhone Safari 17."
      ...
      {onContextCompletionContinue && onContextCompletionSkip && (
        <ContextCompletionModal
          fields={missingContextFields}
          context={values.qaContext}
          onContinue={onContextCompletionContinue}
          onSkip={onContextCompletionSkip}
        />
      )}
    </>
  )
